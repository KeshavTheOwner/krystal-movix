    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ HeY `{message.from_user.first_name}`🥰,\nI ᴄᴏᴜʟᴅɴ'ᴛ ғɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ʏᴏᴜʀ ʀᴇᴏ̨ᴜᴇsᴛ.🤧\n>Tʀʏ ʀᴇᴀᴅɪɴɢ ᴛʜᴇ ɪɴsᴛʀᴜᴄᴛɪᴏɴs ʙᴇʟᴏᴡ 👇\n>Type correct spelling of Movie\n>दोस्त आपकी Movie अभी हमारे Database मे नहीं है । Admin जल्दही आपकी Movie अपलोड करेंगे.🤧\n>आप एक बार नीचे दिए गई ऑप्शन के द्वारा चेक कर लीजिए Movie रिलीज होगई है कि नहीं. 👇",
                                                                                                       reply_markup=InlineKeyboardMarkup([
